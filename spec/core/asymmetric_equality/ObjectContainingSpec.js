describe("ObjectContaining", function() {
  ...
  it("matches when the key/value pair is present in the actual", function() {
    ...
    expect(containing.asymmetricMatch({foo: "fooVal", bar: "barVal"}, [], jasmineUnderTest.matchersUtil)).toBe(true);
  });

  it("does not match when the key/value pair is not present in the actual", function() {
    var containing = new jasmineUnderTest.ObjectContaining({foo: "fooVal"});

    expect(containing.asymmetricMatch({bar: "barVal", quux: "quuxVal"}, [], jasmineUnderTest.matchersUtil)).toBe(false);
  });
  ...
  it("does not match when the key is present but the value is different in the actual", function() {
    ...
    expect(containing.asymmetricMatch({foo: "fooVal", bar: "barVal"}, [], jasmineUnderTest.matchersUtil)).toBe(false);
  });
  ...
  it("matches recursively", function() {
    ...
    expect(containing.asymmetricMatch({one: {two: {}}}, [], jasmineUnderTest.matchersUtil)).toBe(true);
  });
  ...
  it("matches when key is present with undefined value", function() {
    ...
    expect(containing.asymmetricMatch({ one: undefined }, [], jasmineUnderTest.matchersUtil)).toBe(true);
  });
  ...
  it("matches defined properties", function(){
    ...
    expect(containing.asymmetricMatch(definedPropertyObject, [], jasmineUnderTest.matchersUtil)).toBe(true);
  });
  ...
  it("matches prototype properties", function(){
    ...
    expect(containing.asymmetricMatch(obj, [], jasmineUnderTest.matchersUtil)).toBe(true);
  });
  ...
  it("uses custom equality testers", function() {
    ...
    expect(containing.asymmetricMatch({foo: "fooBar"}, [tester], jasmineUnderTest.matchersUtil)).toBe(true);
  });
});
